...
st.set_page_config(page_title="Settings - MEMOAID", layout="wide")
        ...
        <div class="card">
            ...
            <div style="border-top: 1px solid #E5E9EC; padding-top: 16px;">
                <p style="color: #6B7680; font-size: 0.85rem; margin: 0;">
                    MEMOAID stores your cognitive exercise results locally and securely. No personal medical information is shared externally.
                </p>
            </div>
        </div>
    """, unsafe_allow_html=True)

    if st.button("Sign Out of MEMOAID", key="btn_settings_signout", use_container_width=True):

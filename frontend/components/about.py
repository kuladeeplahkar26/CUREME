    ...
    st.markdown("""
        <div style="margin-top: 48px; margin-bottom: 48px; padding: 24px;">
            <div style="margin-bottom: 24px;">
                <span style="color: #F47A45; font-size: 0.875rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.05em;">ABOUT CUREME</span>
            </div>
            ...
            <p style="font-size: 1.25rem !important; color: #424940; max-width: 800px; line-height: 1.6;">
                CUREME combines cognitive activities, adaptive experiences, and caregiver support in a simple interface. We emphasize zero-frustration interfaces, large tap targets, high contrast, and clinically validated recall stimulation to provide a dignified experience for our users.
            </p>
